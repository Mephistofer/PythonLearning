...
list_num = (1, 2, 3, 4)
d = [i * 100 + j * 10 +
     k for i in list_num for j in list_num for k in list_num if (i != j and j != k and k != i)]
print("总数量：", len(d), d)
...
def describe_pet(animal_type='00', pet_name='55', dc='2'):
    """显示宠物的信息"""
    print("\nI have a " + animal_type + ".")
    print("My " + animal_type + "'s name is " + pet_name.title() + "." + dc)


describe_pet(animal_type='hamster', pet_name='harry')
describe_pet(pet_name='harry', animal_type='hamster')
describe_pet(pet_name='77')
